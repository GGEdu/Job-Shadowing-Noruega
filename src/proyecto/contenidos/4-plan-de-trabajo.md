...
```mermaid
flowchart TD
    A["1️⃣ Inmersión en el<br/>departamento de IM"] --> B["2️⃣ Reuniones de<br/>coordinación docente"]
    B --> C["3️⃣ Difusión del<br/>modelo CEEDCV"]
    C --> D["4️⃣ Exploración de<br/>proyectos conjuntos"]
```
